<?php $page_title = "Dashboard"; ?>
       ...
       <?php include realpath(__DIR__ . '/../partials/sidebar.view.php') ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?= $page_title ?>
                    <small>Hello <?= \App\Models\Auth::user()->user_name; ?></small>
                </h1>
                <ol class="breadcrumb">
            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                <li>
                  ...
                  <div class="tools">
                    <a href="/items/<?=$itemId?>"><i class="fa fa-edit"></i></a>
                    <a href="/items/<?=$itemId?>"><i class="fa fa-trash-o"></i></a>
                  </div>
                </li>
                <li>
                      <span class="handle">
      ...
      <!-- /.row (main row) -->
        ...
        <!-- Main Footer -->
       <?php include realpath(__DIR__ . '/../partials/footer.view.php') ?>
